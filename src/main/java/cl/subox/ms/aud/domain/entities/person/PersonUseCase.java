...
public class PersonUseCase implements PersonRepository {
    ...
    public User saveUser(User user) {
        ...
        if (user.getRoles().isEmpty()) {
            throw new PersonException(ContactExceptionEnum.MUST_HAVE_ROLES.toString());
        }
    ...
    public User getUserById(Long id) {
        ...
        throw new PersonException("find user with id: " + id + " but not found");
    }

    @Override
    public User getUserByUserName(String name) {
        throw new PersonException("find user with name: " + name + " but not found");
    }

    @Override
    public User getUserByEmail(String email) {
        throw new PersonException("find user with name: " + email + " but not found");
    }
